...
test("should show when the push happened", function() {
  // this fails because of the format of pushed at.
  // I'm trying to resolve this: http://support.github.com/discussions/post-receive-issues/143-format-of-pushed_at-timestamp-differs-from-other-dates
